...
from user_work_space_manager.models import UserProfile, WorkSpaces
from .choices_projects_task_and_activities import STATE

# Create your models here.
class Project(models.Model):
    created_by_user = models.ForeignKey(UserProfile, on_delete=models.CASCADE, related_name='Project_Users')
...
class CommentsProject(models.Model):
    created_by_user = models.ForeignKey(UserProfile, on_delete=models.CASCADE, related_name='CommentsProject_Users')
...
class Tasks(models.Model):
    created_by_user = models.ForeignKey(UserProfile, on_delete=models.CASCADE, related_name='Tasks_Users')
...
class CommentsTasks(models.Model):
    created_by_user = models.ForeignKey(UserProfile, on_delete=models.CASCADE, related_name='CommentsTasks_Users')
...
class CommentsActivities(models.Model):
    created_by_user = models.ForeignKey(UserProfile, on_delete=models.CASCADE, related_name='CommentsActivities_Users')
